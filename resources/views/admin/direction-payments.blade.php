...
<div class="header">
    <div class="header-left">
        <h1>Direction Payments</h1>
        <p>Manage all direction payment transactions</p>
    </div>
</div>
...
<div class="card" style="margin-top: 20px;">
    <div class="card-header">
        <div class="card-title">All Direction Payments ({{ $payments->count() }})</div>
    </div>
                    ...
                    <td style="padding: 15px; color: #6b7280;">
                        @if($payment->property)
                            <span style="background: #e0e7ff; color: #4338ca; padding: 6px 12px; border-radius: 12px; font-size: 13px; font-weight: 600;">
                                {{ Str::limit($payment->property->address ?? 'Property #' . $payment->properties_id, 30) }}
                            </span>
                        @else
